...
<body>
    ...
    <form action="/install/install-changes.php" method="post">
        ...
        <input class="input" type="text" name="user" placeholder="数据库登录名称" required="required" value=""><br><br>
        <input class="input" type="text" name="pass" placeholder="数据库登录密码" required="required" value=""><br><br>
        <input class="input" type="text" name="dbna" placeholder="数据库表" required="required" value=""><br><br>
        <hr style='border: 0;border-bottom: 1px solid #f0f0f0;'><br>
        <input maxlength="12" class="input" type="text" name="us-nam" placeholder="后台登录名称" required="required" value=""><br><br>
        <input maxlength="12" class="input" type="text" name="us-pas" placeholder="后台登录密码" required="required" value=""><br><br>
...
免费版使用仅限于个人，禁止源码再编后以任何形式转卖和传播，不得用于商业用途(非法售卖源码获利，非个人的群体使用)。支持作者获得商用后移除关于页面页脚信息(https://www.leton.top/spon.html) 。


法律声明

禁止将本程序的源码进行改编出售与其他非法牟利。
...
与我联系：2115271093@qq.com
        ...
        <br><br>
        <input type="submit" value="开始安装" class="biu" id="start"><br>
    </form>
    <div><br><br>
