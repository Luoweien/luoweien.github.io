...
<body>
    ...
    <form action="/install/install-changes.php" method="post">
        ...
        <input class="input" type="text" name="user" placeholder="데이터베이스 로그인 이름" required="required" value=""><br><br>
        <input class="input" type="text" name="pass" placeholder="데이터베이스 로그인 암호" required="required" value=""><br><br>
        <input class="input" type="text" name="dbna" placeholder="데이터베이스 테이블" required="required" value=""><br><br>
        <hr style='border: 0;border-bottom: 1px solid #f0f0f0;'><br>
        <input maxlength="12" class="input" type="text" name="us-nam" placeholder="백그라운드 로그인 이름" required="required" value=""><br><br>
        <input maxlength="12" class="input" type="text" name="us-pas" placeholder="백그라운드 로그인 암호" required="required" value=""><br><br>
        ...
        <br><br>
        <textarea cols="40" rows="70" readonly>
프로그램 소개

LETON 개인 공간(https://www.leton.top/spon.html작가는 여가 시간에 로그에 메시지를 남기는 사이트 원본을 썼는데 주로 도문 로그를 발표하는 데 쓰인다.기능이 간단하고 발문이 빠르며 로그인만 하면 발문이 가능하며 백스테이지로 넘어가지 않아도 된다.간단한 웹 프로그램을 만들어서 상자를 열면 바로 사용할 수 있고 편리하고 빠르다.지원 작성자(https://www.leton.top/spon.html) 。LETON 개인 공간은 HTML CSS JAVASCRIPT PHP MYSQL에서 개발한 로그, 일기를 주요 기능으로 하는 WEB 사이트 프로그램을 사용합니다.기능이 빠르고 인터페이스가 간단하며 사용이 편리하여 로그인 후 당신의 그림 로그를 발표할 수 있습니다.
...
*완전한 사용: 사용 범위 제한 없이 상용 가능.
* 멀티플렉스 지원: 여러 장의 이미지를 지원하기 위해 기사를 보냅니다.
*질문지도: 모르는 것이 있으면 메일로 보내주세요.

사용 범위

무료판 사용은 개인에게만 한정되며 원본 재편성 후 그 어떠한 형식으로도 전매와 전파를 금지하고 상업용도(원본을 불법으로 판매하여 이익을 얻고 개인이 아닌 단체에서 사용)에 사용할 수 없다.지원 작성자가 상용을 획득한 후 페이지 꼬릿말 정보를 제거합니다(https://www.leton.top/spon.html) 。


법적 고지 사항

본 프로그램의 원본을 개편하여 판매하는 것과 기타 불법으로 이익을 얻는 것을 금지한다.
...
|    채널    |       메일박스       |
|-----------|----------------------|
|구매 컨설팅 |2115271093@qq.com     |
|구매 후     |rockstali@outlook.com |
|질문 피드백 |admin@leton.top       |



공식 사이트 주소:https://www.leton.top/spon.html
연락처:2115271093@qq.com

-fanyi.Baidu 번역하다-
</textarea>
        <br><br>
        <input type="submit" value="설치 시작" class="biu" id="start"><br>
    </form>
    <div><br><br>
