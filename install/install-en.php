...
<body>
    ...
    <form action="/install/install-changes.php" method="post">
        ...
        <input class="input" type="text" name="user" placeholder="Database login name" required="required" value=""><br><br>
        <input class="input" type="text" name="pass" placeholder="Database login password" required="required" value=""><br><br>
        <input class="input" type="text" name="dbna" placeholder="Database table name" required="required" value=""><br><br>
        <hr style='border: 0;border-bottom: 1px solid #f0f0f0;'><br>
        <input maxlength="12" class="input" type="text" name="us-nam" placeholder="Webmaster name" required="required" value=""><br><br>
        <input maxlength="12" class="input" type="text" name="us-pas" placeholder="Webmaster password" required="required" value=""><br><br>
        ...
        <br><br>
<textarea cols="40" rows="80" readonly>
Program introduction

Leton personal space（ https://www.leton.top/spon.html ）, the author wrote a website source code of log and message in his spare time, which is mainly used to publish graphic logs. The function is simple and fast. You only need to log in to send a document without jumping to the background to save the residual operation. Create a simple web program, out of the box, convenient and fast. Support author（ https://www.leton.top/spon.html ) 。 Leton personal space uses HTML CSS JavaScript PHP MySQL to develop a web site program with logging and diary as the main function. The function is fast, the interface is simple and easy to use. After logging in, you can publish your graphic log.


        Version support
|   Function  |  free  | professional|
 |-------------|--------|-------------| 
|Personal use |  yes   |     yes     |
|commercial   |  yes   |     yes     |
|Bug feedback |  yes   |     yes     |
|Full use     |   no   |     yes     |
|Update       |   no   |     yes     |
|Multiple PIC |   no   |     yes     |
|guidance     |   no   |     yes     |
...
*Full use: it does not limit the scope of use and can be used commercially.
*Multiple PIC: Post support, multiple pictures.
*guidance: if you don't understand anything, send me an email.


Scope of use

The use of the free version is limited to individuals. It is prohibited to re compile the source code and resell and disseminate it in any form. It shall not be used for commercial purposes (profit from illegal sale of the source code, which is used by non individual groups). Support the author to remove information about the page footer after obtaining commercial information（ https://www.leton.top/spon.html ) 。


Legal declaration

It is prohibited to adapt and sell the source code of this program and make other illegal profits.
...
|passageway  |         Email         |
|------------|-----------------------|
|Questions   |2115271093@qq.com      |
|After sale  |rockstali@outlook.com  |
|Bug feedback|admin@leton.top        |



Official website: https://www.leton.top/spon.html
Contact me: 2115271093@qq.com

-fanyi.Baidu Translate-
</textarea>
        <br><br>
        <input type="submit" value="Start installation" class="biu" id="start"><br>
    </form>
    <div><br><br>
